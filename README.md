...
This [project](https://xuanx1.github.io/fuelLoad/saudi.html) provides interactive dashboards and visualizations for analyzing Saudi Arabia's refinery infrastructure, refined product production, demand patterns, and energy reserves. The visualizations are built using web technologies and present comprehensive energy sector data through interactive charts and maps.
...
- **`saudi.html`** — Testing dashboard combining multiple energy sector metrics and visualizations
...
| `Reserves, Natural Gas csv.csv` | Natural gas reserves and resource data | Energy resource assessment |


## 📈 Features

- **Interactive Maps**: Explore refinery locations with detailed facility information
- **Comparative Analytics**: Visualize production vs. demand relationships
- **Export Analysis**: Track refined product export patterns and trends
- **Resource Monitoring**: Access natural gas reserves and capacity data